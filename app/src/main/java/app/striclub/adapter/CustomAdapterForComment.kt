...
class CustomAdapterForComment(private val coomentList: MutableList<CommentDetail>, private val listner: InterfaceCommentSelectListner, var userId: String?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class ViewHolderRight(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItemsRight(commentDetail: CommentDetail, listner: InterfaceCommentSelectListner) {
    ...
    class ViewHolderLeft(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItemsleft(commentDetail: CommentDetail, listner: InterfaceCommentSelectListner) {
            if(!commentDetail.image.isNullOrEmpty()){
