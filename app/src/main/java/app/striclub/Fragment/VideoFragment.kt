...
import app.striclub.adapter.CustomVideoListFragmentAdpter
...
class VideoFragment : BaseFragment(), InterFaceAllfeedVideoSelectListner, IFragmentManager, InterfaceSelectCatogory, SwipeRefreshLayout.OnRefreshListener {
...
//                mALlFeedVideoAdapter?.notifyItemChanged(post_id_Position!!)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val dialogView = View.inflate(activity, R.layout.receipes_catogory, null)
        dialog_recepies!!.requestWindowFeature(Window.FEATURE_NO_TITLE)
        dialog_recepies!!.setCanceledOnTouchOutside(true)
        dialog_recepies!!.setContentView(dialogView)
...
//        val mRecepiesList = ArrayList<String>()
//        mRecepiesList.add("Veg")
//        mRecepiesList.add("Non Veg")
//        mRecepiesList.add("Egg")
//        mRecepiesList.add("Time")
//        mRecepiesList.add("BreakFast")
//        mRecepiesList.add("Lunch")
//        mRecepiesList.add("Dinner")
//        mRecepiesList.add("Cusines")
//        mRecepiesList.add("Turkish")
//        mRecepiesList.add("Mexican")
//        mRecepiesList.add("Italian")
//        mRecepiesList.add("Japanese")
//        mRecepiesList.add("Indian")
//        mRecepiesList.add("Thai")
//        mRecepiesList.add("French")
//        mRecepiesList.add("Spanish")
...
//        }
        ...
        // dialog_recepies!!.getWindow().setLayout(200, WindowManager.LayoutParams.MATCH_PARENT-20)
