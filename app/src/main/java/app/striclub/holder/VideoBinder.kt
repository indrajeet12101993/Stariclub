...
//        }
    ...
    private fun bindTitle(videoViewHolder: VideoViewHolder, listner: InterFaceAllfeedVideoSelectListner) {
        ...
        if(post.username.isEmpty()){
            videoViewHolder.textViewUsername.text = "Striclub member"
        }else{
            videoViewHolder.textViewUsername.text = post.username
        }
        videoViewHolder.tv_district.text = post.city
        videoViewHolder.tv_city.text = post.state

        videoViewHolder.tv_headline.text = post.title
        videoViewHolder.tv_content.text = Html.fromHtml(post.news_content)
        ...
        if (post.IsSavedpost.equals("0")) {
            ...
            videoViewHolder.tv_user_save.text = videoViewHolder.itemView.context.getString(R.string.savepaost)
            ...
            videoViewHolder.tv_user_save.text = videoViewHolder.itemView.context.getString(R.string.savedpost)
        ...
        videoViewHolder.readmore.setOnClickListener {
            listner.userPostSelectReadMore(post)
        }
