...
import app.striclub.BuildConfig
...
import app.striclub.constants.AppConstants.REQUEST_PICK_PHOTO
...
import  app.striclub.pojo.state.Result
import app.striclub.utils.UtilityFiles.saveBitmapToFile
import java.io.File
...
class UserEditProfileActivity :BaseActivity() , InterfaceStateSelectListner, InterfaceCitySelectListner {
    ...
    private var mAndroidCityList: MutableList<app.striclub.pojo.city.Result>? = null
...
//        val village1: RequestBody = RequestBody.create(MediaType.parse("text/plain"), village)
    ...
    private fun handleResponseUpdateProfile(response: ServerResponseFromUplaodImage) {
        ...
        dialogBuilder.setMessage(" your profile is update !")
    ...
    private fun removeImage() {
        ...
        profile_image.setImageResource(R.drawable.ic_man)
        removimgUserPhoto()
    ...
    private fun initCity() {
        ...
        dialog_city.setTitle(" Select District!")
        ...
        if(state_id.isEmpty()){
           ...
           // alertDialog.setTitle("स्टेट का चयन करें")
            alertDialog.setMessage("Select State!")
