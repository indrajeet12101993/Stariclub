...
import app.striclub.constants.AppConstants.CAMERA_PIC_REQUEST
import app.striclub.constants.AppConstants.IMAGE_DIRECTORY_NAME
import app.striclub.constants.AppConstants.MEDIA_TYPE_IMAGE
import app.striclub.constants.AppConstants.REQUEST_PICK_PHOTO
import app.striclub.constants.AppConstants.REQUEST_TAKE_PHOTO
...
class UserPhotoUploadActivity : BaseActivity() {
    ...
    fun showDialogForRegistationComplete() {
        ...
        builder.setTitle("No Profile Update")
    ...
    private fun handleResponseRemove_Photo(response: ServerResponseFromUplaodImage) {
        ...
        if(response.response_code.equals("0")){
            ...
            alertDialog.setMessage("your profile pic is removed")
