...
import app.striclub.adapter.CustomAdapterForComment
import app.striclub.base.BaseActivity
import app.striclub.base.BaseApplication
import app.striclub.callback.InterfaceCommentSelectListner
...
class HomeSamcharCommentActivity : BaseActivity(), InterfaceCommentSelectListner {
    ...
    // handle sucess response of api call
    private fun handleResponse_home_samchar(responseFromServerAllCommentList: app.striclub.pojo.allCommentListForNews.ResponseFromServerAllCommentList) {
        hideDialogLoading()
    ...
    // handle sucess response of api call
    private fun handleResponse_post_cooment_smachar(responseFromServerAllCommentList: app.striclub.pojo.allCommentListForNews.ResponseFromServerAllCommentList) {
    ...
    // handle sucess response of api call
    private fun handleResponse_delete_cooment_for_samacahr(responseFromServerAllCommentList: app.striclub.pojo.allCommentListForNews.ResponseFromServerAllCommentList) {
