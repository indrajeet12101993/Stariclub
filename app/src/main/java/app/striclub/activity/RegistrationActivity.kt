...
import app.striclub.pojo.ResponseFromServerForUserRegistartion
...
class RegistrationActivity : BaseActivity(), InterfaceStateSelectListner, InterfaceCitySelectListner {
    ...
    private fun initCity() {
        ...
        dialog_city.setTitle(getString(R.string.select_district))
    ...
    private fun initState() {
        ...
        dialog_State.setTitle(getString(R.string.select_state))
