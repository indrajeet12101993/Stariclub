...
class HomeLekhCommentActvity : BaseActivity(), InterfaceCommentSelectListner {
    ...
    // handle sucess response of api call
    private fun handleResponse_delete_cooment_for_lekh(responseFromServerAllCommentList: app.striclub.pojo.allCommentListForNews.ResponseFromServerAllCommentList) {
