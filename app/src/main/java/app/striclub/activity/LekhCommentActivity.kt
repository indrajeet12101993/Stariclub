...
import app.striclub.adapter.CustomAdapterForCommentSamachar
import app.striclub.base.BaseActivity
import app.striclub.base.BaseApplication
import app.striclub.callback.InterfaceCommentForNewsSelectListner
...
import app.striclub.pojo.allCommentListForNews.ResponseFromServerAllCommentList
...
class LekhCommentActivity : BaseActivity(), InterfaceCommentForNewsSelectListner {

    override fun postDelete(commentDetail: CommentDetail, s: String) {
        getdeleteCooment(commentDetail.blog_id, commentDetail.commentid)
    }
    ...
    private fun getAllCooment(post_id: String?) {
        ...
        mCompositeDisposable?.add(ApiRequestClient.createREtrofitInstance()
                .getToatalCommentForLekh(post_id)
    ...
    private fun getPostCooment(comment: String) {
        ...
        mCompositeDisposable_post_comment?.add(ApiRequestClient.createREtrofitInstance()
                .postCommentForLekh(post_id, dataManager.getUserId(), comment)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
    ...
    private fun getdeleteCooment(post_id: String, commentid: String) {
        ...
        mCompositeDisposable_post_comment_Delete?.add(ApiRequestClient.createREtrofitInstance()
                .getDeleteCommentForLekh(commentid, post_id)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
